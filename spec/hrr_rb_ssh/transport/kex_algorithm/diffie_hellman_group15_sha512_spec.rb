...
RSpec.describe HrrRbSsh::Transport::KexAlgorithm::DiffieHellmanGroup15Sha512 do
  ...
  let(:remote_dh){
    ...
    if dh.respond_to?(:set_pqg)
      dh.set_pqg OpenSSL::BN.new(dh_group15_p, 16), nil, OpenSSL::BN.new(dh_group15_g)
    else
      dh.p = OpenSSL::BN.new(dh_group15_p, 16)
      dh.g = OpenSSL::BN.new(dh_group15_g)
    end
    dh.generate_key!
    dh
  }
