...
RSpec.describe HrrRbSsh::Messages::SSH_MSG_CHANNEL_OPEN_FAILURE do
  ...
  describe "::ReasonCode" do
    describe "::SSH_OPEN_ADMINISTRATIVELY_PROHIBITED" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_CHANNEL_OPEN_FAILURE::ReasonCode::SSH_OPEN_ADMINISTRATIVELY_PROHIBITED).to eq value
      end
    end
    ...
    describe "::SSH_OPEN_CONNECT_FAILED" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_CHANNEL_OPEN_FAILURE::ReasonCode::SSH_OPEN_CONNECT_FAILED).to eq value
      end
    end
    ...
    describe "::SSH_OPEN_UNKNOWN_CHANNEL_TYPE" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_CHANNEL_OPEN_FAILURE::ReasonCode::SSH_OPEN_UNKNOWN_CHANNEL_TYPE).to eq value
      end
    end
    ...
    describe "::SSH_OPEN_RESOURCE_SHORTAGE" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_CHANNEL_OPEN_FAILURE::ReasonCode::SSH_OPEN_RESOURCE_SHORTAGE).to eq value
      end
    end
  end
