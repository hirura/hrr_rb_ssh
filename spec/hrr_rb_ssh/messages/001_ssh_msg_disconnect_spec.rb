RSpec.describe HrrRbSsh::Messages::SSH_MSG_DISCONNECT do
  ...
  describe "::ReasonCode" do
    describe "::SSH_DISCONNECT_HOST_NOT_ALLOWED_TO_CONNECT" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_HOST_NOT_ALLOWED_TO_CONNECT).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_PROTOCOL_ERROR" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_PROTOCOL_ERROR).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_KEY_EXCHANGE_FAILED" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_KEY_EXCHANGE_FAILED).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_RESERVED" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_RESERVED).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_MAC_ERROR" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_MAC_ERROR).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_COMPRESSION_ERROR" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_COMPRESSION_ERROR).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_SERVICE_NOT_AVAILABLE" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_SERVICE_NOT_AVAILABLE).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_PROTOCOL_VERSION_NOT_SUPPORTED" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_PROTOCOL_VERSION_NOT_SUPPORTED).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_HOST_KEY_NOT_VERIFIABLE" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_HOST_KEY_NOT_VERIFIABLE).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_CONNECTION_LOST" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_CONNECTION_LOST).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_BY_APPLICATION" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_BY_APPLICATION).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_TOO_MANY_CONNECTIONS" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_TOO_MANY_CONNECTIONS).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_AUTH_CANCELLED_BY_USER" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_AUTH_CANCELLED_BY_USER).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_NO_MORE_AUTH_METHODS_AVAILABLE" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_NO_MORE_AUTH_METHODS_AVAILABLE).to eq value
      end
    end
    ...
    describe "::SSH_DISCONNECT_ILLEGAL_USER_NAME" do
      ...
      it "is defined" do
        expect(HrrRbSsh::Messages::SSH_MSG_DISCONNECT::ReasonCode::SSH_DISCONNECT_ILLEGAL_USER_NAME).to eq value
      end
    end
  end
