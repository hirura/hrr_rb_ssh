...
-----END PUBLIC KEY-----
    ...
    let(:public_key_blob){
      [
        ...
        HrrRbSsh::DataTypes::Mpint.encode(public_key.e.to_i),
        HrrRbSsh::DataTypes::Mpint.encode(public_key.n.to_i),
      ].join
    }
...
-----END RSA PRIVATE KEY-----
    ...
    let(:public_key_blob){
      [
        ...
        HrrRbSsh::DataTypes::Mpint.encode(pkey.e.to_i),
        HrrRbSsh::DataTypes::Mpint.encode(pkey.n.to_i),
      ].join
    }
