...
RSpec.describe HrrRbSsh::Codable do
    ...
    describe ".encode" do
      ...
      context "when arg is not acceptable by data_type" do
        it "raises an error" do
          expect { mixed_in.encode( {:'message number' => 168, :'data' => nil} ) }.to raise_error ArgumentError
        end
      end
    end
  ...
  context "when module has CONDITIONAL_DEFINITION" do
    ...
    describe ".encode" do
      ...
      context "when arg is not acceptable by data_type" do
        it "raises an error" do
          expect { mixed_in.encode( {:'message number' => 168, :'data' => 'testing', :'testing data' => nil} ) }.to raise_error ArgumentError
        end
      end
    end
  ...
  context "when module has chained CONDITIONAL_DEFINITION" do
    ...
    describe ".encode" do
      ...
      context "when arg is not acceptable by data_type" do
        it "raises an error" do
          expect { mixed_in.encode( {:'message number' => 168, :'data' => 'testing', :'testing data' => 'conditional', :'chained data' => nil} ) }.to raise_error ArgumentError
        end
      end
    end
  ...
  context "when module has CONDITIONAL_DEFINITION that requires complementary message" do
    ...
    describe ".encode" do
      context "when arg does not contain an instance of Proc" do
        it "encodes #{{:'message number' => 168, :'data' => 'testing', :'hidden data' => 'conditional'}.inspect} with complementary message #{{:'require hidden' => true}.inspect} to \"A8 00 00 00 07 t e s t i n g 00 00 00 0B c o n d i t i o n a l\"" do
          expect( mixed_in.encode( {:'message number' => 168, :'data' => 'testing', :'hidden data' => 'conditional'}, {:'require hidden' => true}, logger: nil ) ).to eq( ["A8", "00000007", "testing", "0000000B", "conditional"].pack("H*H*a*H*a*") )
        end
      end
      ...
      context "when arg contains an instance of Proc" do
        it "encodes #{{:'message number' => 168, :'data' => lambda { 'testing' }, :'hidden data' => lambda { 'conditional' }}.inspect} with complementary message #{{:'require hidden' => lambda { true }}.inspect} to \"A8 00 00 00 07 t e s t i n g 00 00 00 0B c o n d i t i o n a l\"" do
          expect( mixed_in.encode( {:'message number' => 168, :'data' => lambda { 'testing' }, :'hidden data' => lambda { 'conditional' }}, {:'require hidden' => lambda { true }}, logger: nil ) ).to eq( ["A8", "00000007", "testing", "0000000B", "conditional"].pack("H*H*a*H*a*") )
        end
      end

      context "when arg is not acceptable by data_type" do
        it "raises an error" do
          expect { mixed_in.encode( {:'message number' => 168, :'data' => 'testing', :'hidden data' => nil}, {:'require hidden' => true}, logger: nil ) }.to raise_error ArgumentError
        end
      end
    end
    ...
    describe ".decode" do
      it "decodes \"A8 00 00 00 07 t e s t i n g 00 00 00 0B c o n d i t i o n a l\" with complementary message #{{:'require hidden' => true}.inspect} to #{{:'message number' => 168, :'data' => 'testing', :'hidden data' => 'conditional'}.inspect}" do
        expect( mixed_in.decode( ["A8", "00000007", "testing", "0000000B", "conditional"].pack("H*H*a*H*a*"), {:'require hidden' => true}, logger: nil ) ).to eq( {:'message number' => 168, :'data' => 'testing', :'hidden data' => 'conditional'} )
      end
    end
  end
end
