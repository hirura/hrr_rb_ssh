  ...
  context "when 'request type' is \"pty-req\"" do
    ...
    let(:payload){
      [
        ...
        HrrRbSsh::Transport::DataType::String.encode(message['TERM environment variable value']),
        HrrRbSsh::Transport::DataType::Uint32.encode(message['terminal width, characters']),
        HrrRbSsh::Transport::DataType::Uint32.encode(message['terminal height, rows']),
        HrrRbSsh::Transport::DataType::Uint32.encode(message['terminal width, pixels']),
        HrrRbSsh::Transport::DataType::Uint32.encode(message['terminal height, pixels']),
        HrrRbSsh::Transport::DataType::String.encode(message['encoded terminal modes']),
      ].join
    }
  ...
  context "when 'request type' is \"x11-req\"" do
    ...
    let(:payload){
      [
        ...
        HrrRbSsh::Transport::DataType::String.encode(message['request type']),
        HrrRbSsh::Transport::DataType::Boolean.encode(message['want reply']),
        HrrRbSsh::Transport::DataType::Boolean.encode(message['single connection']),
        HrrRbSsh::Transport::DataType::String.encode(message['x11 authentication protocol']),
        HrrRbSsh::Transport::DataType::String.encode(message['x11 authentication cookie']),
        HrrRbSsh::Transport::DataType::Uint32.encode(message['x11 screen number']),
      ].join
    }
  ...
  context "when 'request type' is \"env\"" do
    ...
    let(:payload){
      [
        ...
        HrrRbSsh::Transport::DataType::String.encode(message['request type']),
        HrrRbSsh::Transport::DataType::Boolean.encode(message['want reply']),
        HrrRbSsh::Transport::DataType::String.encode(message['variable name']),
        HrrRbSsh::Transport::DataType::String.encode(message['variable value']),
      ].join
    }
  ...
  context "when 'request type' is \"exec\"" do
    ...
    let(:payload){
      [
        ...
        HrrRbSsh::Transport::DataType::String.encode(message['request type']),
        HrrRbSsh::Transport::DataType::Boolean.encode(message['want reply']),
        HrrRbSsh::Transport::DataType::String.encode(message['command']),
      ].join
    }
  ...
  context "when 'request type' is \"subsystem\"" do
    ...
    let(:payload){
      [
        ...
        HrrRbSsh::Transport::DataType::String.encode(message['request type']),
        HrrRbSsh::Transport::DataType::Boolean.encode(message['want reply']),
        HrrRbSsh::Transport::DataType::String.encode(message['subsystem name']),
      ].join
    }
  ...
  context "when 'request type' is \"window-change\"" do
    ...
    let(:payload){
      [
        ...
        HrrRbSsh::Transport::DataType::String.encode(message['request type']),
        HrrRbSsh::Transport::DataType::Boolean.encode(message['want reply']),
        HrrRbSsh::Transport::DataType::Uint32.encode(message['terminal width, columns']),
        HrrRbSsh::Transport::DataType::Uint32.encode(message['terminal height, rows']),
        HrrRbSsh::Transport::DataType::Uint32.encode(message['terminal width, pixels']),
        HrrRbSsh::Transport::DataType::Uint32.encode(message['terminal height, pixels']),
      ].join
  ...
  context "when 'request type' is \"xon-xoff\"" do
    ...
    let(:payload){
      [
        ...
        HrrRbSsh::Transport::DataType::String.encode(message['request type']),
        HrrRbSsh::Transport::DataType::Boolean.encode(message['want reply']),
        HrrRbSsh::Transport::DataType::Boolean.encode(message['client can do']),
      ].join
    }
  ...
  context "when 'request type' is \"signal\"" do
    ...
    let(:payload){
      [
        ...
        HrrRbSsh::Transport::DataType::String.encode(message['request type']),
        HrrRbSsh::Transport::DataType::Boolean.encode(message['want reply']),
        HrrRbSsh::Transport::DataType::String.encode(message['signal name']),
      ].join
    }
  ...
  context "when 'request type' is \"exit-status\"" do
    ...
    let(:payload){
      [
        ...
        HrrRbSsh::Transport::DataType::String.encode(message['request type']),
        HrrRbSsh::Transport::DataType::Boolean.encode(message['want reply']),
        HrrRbSsh::Transport::DataType::Uint32.encode(message['exit status']),
      ].join
    }
  ...
  context "when 'request type' is \"exit-signal\"" do
    ...
    let(:payload){
      [
        ...
        HrrRbSsh::Transport::DataType::Boolean.encode(message['want reply']),
        HrrRbSsh::Transport::DataType::String.encode(message['signal name']),
        HrrRbSsh::Transport::DataType::Boolean.encode(message['core dumped']),
        HrrRbSsh::Transport::DataType::String.encode(message['error message']),
